...
def setup(args):
    ...
    """
    if args.actual:
        register_coco_instances('leaf_train', {},
                                f'/data/segmentation/p_{args.species}/actual/{args.species}_train_actual.json',
                                f'/data/segmentation/p_{args.species}/actual/img_v2/train')
        if args.eval_only:
            register_coco_instances('leaf_test', {},
                                    f'/data/segmentation/p_{args.species}/{args.species}_test.json',
                                    f'/data/segmentation/p_{args.species}/test')
        else:
            register_coco_instances('leaf_test', {},
                                    f'/data/segmentation/p_{args.species}/actual/{args.species}_validation_actual.json',
                                    f'/data/segmentation/p_{args.species}/actual/img_v2/validation')
    else:
        register_coco_instances('leaf_train', {},
                                f'/data/segmentation/p_{args.species}/{args.species}_train.json',
                                f'/data/segmentation/p_{args.species}/train/img')
        if args.eval_only:
            register_coco_instances('leaf_test', {}, f'/data/segmentation/p_{args.species}/{args.species}_test.json',
                                    f'/data/segmentation/p_{args.species}/test')
        else:
            register_coco_instances('leaf_test', {},
                                    f'/data/segmentation/p_{args.species}/{args.species}_validation.json',
                                    f'/data/segmentation/p_{args.species}/validation/img')
    ...
    if args.actual:
        cfg.OUTPUT_DIR = f'./output_{args.species}_comp'
    else:
        cfg.OUTPUT_DIR = f'./exprs/{args.species}/v{str(args.version)}'
    cfg.freeze()

...
class Exec:
    ...
    def exec(self,
        ...
        self.objects, self.turtle_string = execute(context,
                               axiom,
                               rules,
                               self.replacements,
...
def exec_turtle(context, lsys, instances, min_iterations, max_iterations, animate, turtle, frame_delta=5):
    ...
    for instance in range(0, instances):
        ...
        for iterations in range(min_iterations, rmax_iter):
            ...
            object_base_pairs, turtle_string = run_once(context, new_turtle, instance, lsys, iterations)
            if pos_info:
...
def run_once(context, turtle, instance, lsys, iterations):
    ...
    return object_base_pairs, result
